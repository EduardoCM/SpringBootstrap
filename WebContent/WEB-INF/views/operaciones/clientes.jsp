		...
		<div class="jumbotron">
			...
			<sf:form action="guardarCliente" method="post" commandName="cliente">
				...
				<div class="form-group">
					...
					<sf:input path="direccion1" type="text" class="form-control" id="inputAddress" placeholder="1234 Main St" />
				</div>
				<div class="form-group">
					<label for="inputAddress2">Direccion 2</label> 
					<sf:input path="direccion2" type="text" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" />
				</div>
				<div class="form-row">
					<div class="form-group col-md-6">
						<label for="inputCiudad">Ciudad</label> 
						<sf:input path="ciudad"  type="text" class="form-control" id="inputCiudad" />
					</div>
					<div class="form-group col-md-4">
						<label for="inputEstado">Estado</label> 
						<sf:input path="estado" type="text" class="form-control" id="inputEstado" />
					</div>
					<div class="form-group col-md-2">
						<label for="inputCodigoPostal">Codigo Postal</label> 
						<sf:input path="codigoPostal"  type="text" class="form-control" id="inputCodigoPostal" />
					</div>
				</div>
