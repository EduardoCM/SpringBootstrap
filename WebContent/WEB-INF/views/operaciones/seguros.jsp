        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href='<c:url value="/seguros" />'>Seguros</a></li>
              <li><a href='<c:url value="/cobranza" />'>Cobranza</a></li>
              <li><a href='<c:url value="/seguimiento" />'>Registro de afore</a></li>
              <li><a href='<c:url value="/reportes" />'>Reporte de robos</a></li>
